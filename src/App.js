  ...
  return (
    <div className="container">
      ...
      <section className="buttons">
        ...
        <div>
          <button className="awayButtons__touchdown" onClick={() => setQuarterCount(quarterCount + 1)}>Quarter</button>
          <button className="awayButtons__touchdown" onClick={() => setQuarterCount(1)}>Quarter reset</button>
        </div>
      </section>
    </div>
  );
